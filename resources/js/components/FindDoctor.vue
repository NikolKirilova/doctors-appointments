<template>
  <div>
    <div class="card">
      ...
      <div class="card-body">
        <datepicker class="my-datepicker" calendar-class="my-datepicker_calendar"  :disabledDates="disabledDates"   :format="customDate"
          v-model="time"
          :inline="true"
        ></datepicker>
      </div>
      ...
      <div class="card-body">
        <table class="table table-striped">
          ...
          <tbody>
              ...
              <td>
                <a :href="'/new-appointment/' + doctor.user_id + '/' + doctor.date"
